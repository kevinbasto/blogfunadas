...
export const GenresHeaders    : Array<TableHeader>  = [{ name : "nombre", property : "name"}, { name : "fecha", property : "creationDate"}];
export const NovelsHeaders    : Array<TableHeader>  = [{ name : "id", property: 'id'}, { name : "nombre", property : "name"},{ name : "capítulos", property: "chapters"}];
export const ChaptersHeaders  : Array<TableHeader>  = [{ name : "id", property : "id"},{ name : "nombre", property: "title"}];
