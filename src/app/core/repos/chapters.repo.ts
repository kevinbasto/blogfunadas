...
export interface ChaptersRepo{
    createChapter( genre : string, novel : string, chapterId : string, chapter : Chapter) : Promise<any>;
    getChapter( genre : string, novel : string, chapterId : string ) : Promise<Chapter>;
